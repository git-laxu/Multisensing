...
export interface BinocularCameraSaveConfig {
  ...
  tracked_video_view: 'left' | 'right'; // 追踪视频视角
  tracked_image_views: 'left' | 'right' | 'both'; // 追踪图像视角
  raw_image_views: 'left' | 'right' | 'both'; // 原始图像视角
  raw_video_view: 'left' | 'right' | 'both'; // 原始视频视角
}
